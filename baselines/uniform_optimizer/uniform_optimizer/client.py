...
class FlwrClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):     
        ...
        log(INFO, f"Trainint on fraction {fraction_samples} of the training set, batch size {batch_size}, and {epochs} epochs")
...
def gen_client_fn(epochs: Tuple[int, int], fraction_samples: Tuple[int, int], batch_size: Tuple[int, int], num_clients: int) -> Callable[[str], fl.client.Client]:
